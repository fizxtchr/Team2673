...
public class ArmSubsystem extends SubsystemBase {
  ...
  public void incrementEncoder(double increment){
    m_encoder.setPosition(m_encoder.getPosition() + increment);
  ...
  public void periodic() { // This method will be called once per scheduler run
    //SmartDashboard.putNumber("Arm Pos", m_motor.getPosition());
  }
}
